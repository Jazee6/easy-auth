...
--> statement-breakpoint
CREATE INDEX `oauthClientAudit_ownerUserId_createdAt_idx` ON `oauth_client_audit` (`owner_user_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `oauthClientAudit_ownerUserId_clientId_idx` ON `oauth_client_audit` (`owner_user_id`,`client_id`);--> statement-breakpoint
